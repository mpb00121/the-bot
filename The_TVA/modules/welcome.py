...
import The_Tva.modules.sql.welcome_sql as sql
from The_Tva import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from The_Tva.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
from The_Tva.modules.helper_funcs.misc import build_keyboard, revert_buttons
from The_Tva.modules.helper_funcs.msg_types import get_welcome_type
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh !! Hey my Owner, let's get this moving (｡•̀ᴗ-)✧.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
