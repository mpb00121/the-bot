...
import The_Tva.modules.sql.global_bans_sql as sql
from The_Tva.modules.sql.users_sql import get_user_com_chats
from The_Tva import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from The_Tva.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    if user_id in [2076923389, 2076923389]:
        message.reply_text("Fool! You can't attack Telegram's @The_TVA!")
        return
