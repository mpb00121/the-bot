...
import The_Tva.modules.sql.userinfo_sql as sql
from The_Tva import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from The_Tva import telethn as SaitamaTelethonClient
from The_Tva.__main__ import STATS, TOKEN, USER_INFO
from The_Tva.modules.disable import DisableAbleCommandHandler
from The_Tva.modules.helper_funcs.chat_status import sudo_plus
from The_Tva.modules.helper_funcs.extraction import extract_user
from The_Tva.modules.sql.afk_sql import check_afk_status, is_afk
from The_Tva.modules.sql.global_bans_sql import is_user_gbanned
from The_Tva.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        ...
        text += ' [<a href="https://t.me/The_TVA">?</a>]'.format(bot.username)
...
*Overall Information about you:*
 ☉ /infob*:* get information about a user. 
