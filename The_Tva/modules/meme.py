...
import The_Tva.modules.helper_funcs.fun_strings as fun
from The_Tva import DEMONS, DRAGONS, dispatcher
from The_Tva.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
