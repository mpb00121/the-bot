...
from The_Tva import DEMONS, DEV_USERS, DRAGONS, OWNER_ID, TIGERS, WOLVES, dispatcher
from The_Tva.modules.helper_funcs.chat_status import dev_plus, sudo_plus, whitelist_plus
from The_Tva.modules.helper_funcs.extraction import extract_user
from The_Tva.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "The_Tva/elevated_users.json")
...
def devlist(update: Update, context: CallbackContext):
    ...
    reply = "<b>The_TVA Developers ⚡️:</b>\n"
