...
from The_Tva.modules.helper_funcs.extraction import extract_user_and_text
from The_Tva.modules.helper_funcs.string_handling import extract_time
from The_Tva.modules.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    try:
        ...
        reply = (
            ...
            f"<code> </code><b> 😏User:</b> {mention_html(member.user.id, html.escape(member.user.first_name))} By me @The_Tva"
