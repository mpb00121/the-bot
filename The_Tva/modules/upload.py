...
from The_Tva import telethn as bot
from The_Tva.modules.urluploader import download_file
from The_Tva.utils.uputils import humanbytes, progress
...
async def send_to_tmp_async(file):
    url = "https://tmp.ninja/upload.php?d=upload-tool"
