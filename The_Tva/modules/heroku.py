...
from The_Tva import telethn as borg, HEROKU_APP_NAME, HEROKU_API_KEY, OWNER_ID
from The_Tva.events import register
from The_Tva.function.heroku_helper import HerokuHelper
...
async def restart_bot(dyno):
    ...
    if dyno.sender_id == OWNER_ID:
        ...
        return await dyno.reply("The_TVA will be restarted..."
         )
    args = [sys.executable, "-m", "The_Tva"]
