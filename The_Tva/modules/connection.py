...
import The_Tva.modules.sql.connection_sql as sql
from The_Tva import DEV_USERS, DRAGONS, dispatcher
from The_Tva.modules.helper_funcs import chat_status
    ...
    if update.effective_chat.type == "private":
        ...
        if (isadmin) or (isallow and ismember) or (user.id in DRAGONS):
            ...
            if connection_status:
                ...
                send_message(
                    update.effective_message,
                    "Successfully connected to *{}*.@The_Tva".format(chat_name),
                    parse_mode=ParseMode.MARKDOWN,
                )
                try:
