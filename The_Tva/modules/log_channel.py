...
if is_module_loaded(FILENAME):
    ...
    from The_Tva import EVENT_LOGS, LOGGER, dispatcher
    from The_Tva.modules.helper_funcs.chat_status import user_admin
    from The_Tva.modules.sql import log_channel_sql as sql
    ...
    __help__ = """
*Admins only:*
☉ /logchannelv*:* get log channel info
☉ /setlogv*:* set the log channel.
