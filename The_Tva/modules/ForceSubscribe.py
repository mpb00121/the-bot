...
from The_Tva import DRAGONS as SUDO_USERS
from The_Tva import pbot
from The_Tva.modules.sql import forceSubscribe_sql as sql
...
__help__ = """
*ForceSubscribe:*
❍ The_TVA can mute members who are not subscribed your channel until they subscribe.
