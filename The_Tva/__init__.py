...
if ENV:
    ...
    from The_Tva.config import Development as Config
...
pbot = Client("The_Tva", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from The_Tva.modules.helper_funcs.handlers import (
